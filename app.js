    ...
    const currentPosition = navigator.geolocation.getCurrentPosition(function (position){
        ...
        $.ajax({
            ...
            success:function(data){
                ...
                $('#place').text(` ${data.results[0].components.suburb},${data.results[0].components.city},${data.results[0].components.state},${data.results[0].components.country},${data.results[0].components.continent}`)
                ...
                $.ajax(
                    { 
                        url: `https://api.unsplash.com/search/photos/?client_id=1PxLhagaDb8qlR8vyKKTBy7modcHos4-l5-GXvJV_Lk&query=${data.results[0].components.state_district}`,
                ...
                $.ajax(
                    { 
                        url: `https://api.unsplash.com/search/photos/?client_id=1PxLhagaDb8qlR8vyKKTBy7modcHos4-l5-GXvJV_Lk&query=${data.results[0].components.suburb}`,
